"""
Interpolate missing bounding box data between frames.
Reads a detection CSV and fills gaps with linear interpolation.
...
def interpolate_bounding_boxes(data):
    """Interpolate missing frames for each tracked car."""
...
def main():
    parser = argparse.ArgumentParser(description='Interpolate missing bounding box data')
    parser.add_argument('--input', '-i', default='./output/results.csv',
                        help='Path to input CSV file')
    parser.add_argument('--output', '-o', default='./output/results_interpolated.csv',
                        help='Path to output interpolated CSV file')
    ...
    print(f'Interpolated {len(interpolated_data)} rows → {args.output}')
